...
gcc -fpic -c -I$mdNamePath -I$JavaIncludeDirectory1 -I$JavaIncludeDirectory2 mdNameJavaWrapper.cpp
gcc -g -shared mdNameJavaWrapper.o -o libmdNameJavaWrapper.so -L$mdNamePath -lmdName -pthread
