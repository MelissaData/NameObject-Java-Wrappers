...
- Melissa Name Object for 2026-07
...
#### Configure Scripts
If you want to generate `mdNameJavaWrapper.dll`, you will execute the `BuildNameJavaWrapper.ps1` script. This may require you to configure some path variables in `Build.ps1` and `BuildNameJavaWrapper.ps1`.
