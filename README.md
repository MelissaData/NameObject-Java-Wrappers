# Melissa - Name Object Java Wrappers

## Purpose
This is the code for you to run Name Object in Java.
...
```
$ git clone https://github.com/MelissaData/NameObject-Java-Wrappers.git
$ cd NameObject-Java-Wrappers
```

### Copy wrappers to your project folder
Import the `com` folder, and `mdNameJavaWrapper.dll` (Windows) or `libmdNameJavaWrapper.so` (Linux) to your project, and include the following line in your code to begin using the wrapper.
...
#### Configure Scripts
If you want to generate `mdNameJavaWrapper.dll`, you will execute the `BuildNameJavaWrapper.ps1` script. This may require you to configure some path variables in `BuildWrapper.ps1` and `BuildNameJavaWrapper.ps1`.
...
It is important to note that you must be able to initialize the Visual Studio Developer Command Prompt environment for `x86_x64` to generate `mdNameJavaWrapper.dll`.
...
#### Configure Script
If you want to generate `libmdNameJavaWrapper.so`, you will execute the `BuildNameJavaWrapper.sh` script. This may require you to configure some path variables in `BuildNameJavaWrapper.sh`.
...
----------------------------------------
## See also
- [Melissa - Name Object Windows Java](https://github.com/MelissaData/NameObject-Java)
- [Melissa - Name Object Linux Java](https://github.com/MelissaData/NameObject-Java-Linux)
